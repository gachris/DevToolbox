...
/// </summary>
public class LayoutDockOverlayButtonAdorner : Adorner
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LayoutDockOverlayButtonAdorner"/> class,
    /// adorning the specified UI element.
    /// </summary>
    /// <param name="adornedElement">The element to adorn with the overlay.</param>
    public LayoutDockOverlayButtonAdorner(UIElement adornedElement) : base(adornedElement)
    {
